\section{9.2 Lorentz Violation Effects in Ultra-High-Energy Cosmic Rays}
...
\subsection{9.2.1 Dispersion Relation of Light Speed}
...
This means \textbf{ultra-high-energy photons (or neutrinos) will have velocity weakly dependent on their energy.}

\begin{itemize}
\item If $\eta < 0$, high-energy photons are slower than low-energy photons (subluminal).
\end{enumerate}

\begin{itemize}
\item If $\eta > 0$, high-energy photons are faster than low-energy photons (superluminal).

\subsection{9.2.2 Observational Opportunity}

Universe provides us natural super accelerators—\textbf{Gamma-Ray Bursts (GRB)}.
...
\subsection{9.2.3 Prediction}

Instruments like Fermi Gamma-ray Space Telescope (Fermi LAT) should observe: \textbf{High-energy photons from same burst source arrive at Earth systematically earlier (or later) than low-energy photons.}
