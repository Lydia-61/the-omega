\section{9.3 Cosmological Drift of Fine Structure Constant}
...
However, universe is expanding. From QCA perspective, expansion is not just lattice spacing stretching (that's metric effect), but may also accompany \textbf{evolution of network topological structure} (e.g., increase in lattice point number or reorganization of connection patterns).
...
\subsection{9.3.1 Observational Scheme}
