...
* **Result:** A black hole forms. Internal evolution stops (**$v_{int} \to 0$**). Although data is not lost (holographic storage), it no longer occupies active computing bandwidth.
