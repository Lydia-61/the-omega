...
This is a mathematical **Stationary Point**, i.e., $\delta S = 0$.
...
* Result: **$e^{iS_A} + e^{iS_B} + e^{iS_C} \approx 3 \times e^{iS}$**.
...
* **$iS$ (phase cost)** acts as a filter.
