...
* **Network Stripping**: To compress information, network layers continuously contract inward (renormalization flow $UV \to IR$).
...
* $c_{FS}$ (computational power) cannot be allocated here.

* $v_{int}$ (structure) cannot be parsed here.
