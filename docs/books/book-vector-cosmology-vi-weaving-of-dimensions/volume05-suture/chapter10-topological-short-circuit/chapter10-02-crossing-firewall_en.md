...
* **Exponential growth of $c(\tau)$**: As the cosmic total budget explodes, future computational power will far exceed what today's physicists imagine.
...
It is filled with highly compressed **$v_{int}$ structures** transformed from matter that previously fell in.
