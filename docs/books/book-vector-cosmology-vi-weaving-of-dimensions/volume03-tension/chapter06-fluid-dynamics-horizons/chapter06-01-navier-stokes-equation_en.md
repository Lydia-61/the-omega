...
This leads to the theme of the next section: **Viscosity Coefficient**. We will see that Planck's constant $\hbar$ actually defines the **"thickness"** of this cosmic soup. It is the **damping** set by the universe to prevent information processing overload.
