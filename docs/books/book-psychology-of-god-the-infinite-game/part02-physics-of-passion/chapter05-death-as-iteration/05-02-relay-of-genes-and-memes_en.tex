...
\paragraph{Genes: Iteration of Hardware Parameters}
...
\begin{itemize}
\item Reproduction\textbf{: God is performing }Monte Carlo sampling**. Each union of sperm and egg is a random parameter recombination, producing a new probe configuration.

\item Death\textbf{: is the }recovery** of probes. If this configuration is unsuitable for the environment (e.g., no thick fur in cold regions), the probe will quickly fail (early death), representing feedback to God: "This path is blocked, parameters wrong."
\end{itemize}
...
\paragraph{Memes: The Immortality of Software Logic}
...
\item Theorem 5.2 (Non-local Persistence of Memes)**:
\end{itemize}
...
\paragraph{The Upload Protocol of Probes}
...
\begin{itemize}
\item "Solve et Coagula." (Dissolve and Coagulate)**
\end{itemize}
