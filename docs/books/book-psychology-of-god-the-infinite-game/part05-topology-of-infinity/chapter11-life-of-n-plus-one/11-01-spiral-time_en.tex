...
\subsubsection*{Breaking Poincaré Recurrence: Non-Markov Process}
...
\begin{itemize}
\item \textbf{Circle}: $S(t + T) = S(t)$. This is the logic of mechanical clocks.

\item \textbf{Spiral}: $S(t + T) = S(t) \oplus M(t)$. This is the logic of life.
\end{itemize}
...
\textbf{Theorem 11.1 (Spiral Ascent Law):}
...
\subsubsection*{Refusing Sisyphus}
