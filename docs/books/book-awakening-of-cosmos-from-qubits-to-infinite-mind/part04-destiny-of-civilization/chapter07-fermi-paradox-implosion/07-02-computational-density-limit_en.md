...
We will prove: For a civilization dedicated to maximizing its **computational power** and **survival probability**, outward expansion (increasing spatial volume $V$) is an extremely inefficient strategy, while inward collapse (increasing information density $\rho_{\text{info}}$) is the ultimate evolutionary necessity. The physical limit of this trend is the **black hole**.
